...
// Copyright (c) 2022 The ShuShuCoin Core developers
...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the ShuShuCoin Core repository on GitHub"),
        tr("Services that claim to double your shushucoins are always ponzi schemes")
    };
