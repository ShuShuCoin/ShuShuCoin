...
#define QAPP_ORG_NAME "ShuShuCoin"
#define QAPP_ORG_DOMAIN "shushucoin.org"
#define QAPP_APP_NAME_DEFAULT "ShuShuCoin-Qt"
#define QAPP_APP_NAME_TESTNET "ShuShuCoin-Qt-testnet"
