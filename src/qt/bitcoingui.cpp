...
// Copyright (c) 2021-2023 The ShuShuCoin Core developers
    ...
    platformStyle(_platformStyle)
{
    ...
    // ShuShuCoin: load fallback font in case Comic Sans is not available on the system
    ...
    // ShuShuCoin: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // ShuShuCoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // ShuShuCoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ShuShuCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and shushucoin: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ShuShuCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ShuShuCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a shushucoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a ShuShuCoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible ShuShuCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to ShuShuCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("ShuShuCoin"); // default title
